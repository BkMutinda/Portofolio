...
const Nav = () => {
  ...
  return (
    <>
      <div className="header_container h-25  sticky z-30 top-0 bg-black flex justify-between items-center  border-b-[1px] border-b-gray-200   ">
        ...
        <motion.div className="  ">
          ...
          <FaBars
            className="bars text-3xl hover:cursor-pointer relative sm:hidden "
            onClick={openSideBar}
          />
